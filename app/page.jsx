...
export const metadata = {
  ...
  description: "Connect with reliable, professional caregivers for children, elderly, and special care needs. Find trusted babysitters, elderly care, sick care, and more.",
  keywords: "caregiver, babysitter, elderly care, sick care, childcare, home care, Bangladesh, Dhaka",
  openGraph: {
    title: "CareLoom - Trusted Care Services",
    description: "Connecting families with reliable, professional caregivers for children, elderly, and special care needs",
    url: "https://careloom.com",
    siteName: "CareLoom",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "CareLoom - Trusted Care Services",
      },
    ],
    locale: "en_US",
    type: "website",
